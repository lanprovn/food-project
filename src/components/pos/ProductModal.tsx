    ...
    <>
      ...
      <div className="fixed right-[23%] top-20 max-h-[calc(100vh-5rem)] w-[550px] max-w-[48%] bg-white shadow-2xl z-50 overflow-hidden flex flex-col rounded-2xl animate-slide-in-right border border-gray-200">
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200 bg-gradient-to-r from-orange-50 to-amber-50 animate-fade-in">
          ...
          <button
            onClick={onClose}
            className="p-2 hover:bg-gray-200 rounded-full transition-all duration-300 hover:scale-110 active:scale-95 hover:rotate-90"
          >
            <XMarkIcon className="w-5 h-5 text-gray-600 transition-colors duration-300 hover:text-red-600" />
          </button>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-6">
                  ...
                  <button
                    ...
                    className={`w-full p-3 rounded-lg border-2 text-left transition-all duration-300 ${
                      selectedSize?.name === size.name
                        ...
                        : 'border-gray-200 hover:border-orange-300 bg-white hover:scale-105 active:scale-95'
                    }`}
                  >
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent resize-none transition-all duration-300 hover:border-orange-300 focus:shadow-lg focus:shadow-orange-200"
              rows={3}
            />
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center space-x-3">
              <button
                ...
                className="w-10 h-10 rounded-lg bg-gray-200 hover:bg-gray-300 flex items-center justify-center font-bold text-gray-600 transition-all duration-300 hover:scale-110 active:scale-95 hover:bg-red-100 hover:text-red-600"
              >
                -
              </button>
              <span className="text-xl font-bold text-gray-800 min-w-[3rem] text-center transition-all duration-300">
                {quantity}
              </span>
              <button
                onClick={() => setQuantity(quantity + 1)}
                className="w-10 h-10 rounded-lg bg-gray-200 hover:bg-gray-300 flex items-center justify-center font-bold text-gray-600 transition-all duration-300 hover:scale-110 active:scale-95 hover:bg-green-100 hover:text-green-600"
              >
                +
              </button>
            </div>
          ...
          {/* Total Price */}
          <div className="p-4 bg-gray-50 rounded-lg mb-4 transition-all duration-300 hover:shadow-md animate-fade-in">
            <div className="flex justify-between items-center">
              <span className="text-lg font-semibold text-gray-700">Tổng cộng:</span>
              <span className="text-2xl font-bold text-orange-600 transition-all duration-300 animate-pulse-slow">
